...
public class FindUpdate extends Phase {
	...
	/**
	 * Trova il nodo di testo con "somiglianza" massima nello spazio specificato
	 * da intA e intB
	 * 
	 * @param intA
	 ...
	 * @param findA
	 *            Nodo trovato sul documento A (in questo caso l'intervallo avrà
	 *            dimensione al massimo 1)
	 * @param findB
	 *            Nodo trovato sul docuemnto B (in questo caso l'intervallo avrà
	 *            dimensione al massimo 1)
	 */
	private void FindMaxUpdate(Interval intA, Interval intB, Interval findA,
		...
		/* Se max è una percentuale qua metto la soglia di riferimento */
