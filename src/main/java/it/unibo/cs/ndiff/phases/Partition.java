...
/**
 * @author Mike Crea le associazioni di uguaglianza tra i due documenti in
 *         input.
 * 
 */
public class Partition extends Phase {
	...
	/**
	 * Restituisce la sottosequenza continua comune massima negli intervalli
	 * esaminati
	 * 
	 * @param intA
	 *            - Intervallo da esaminare sul documento A
	 * @param intB
	 *            - Intervallo da esaminare sul documento B
	 * @param findA
	 *            - Intervallo trovato uguale nello spazio esaminato(size <=0 se
	 *            nn viene trovata nessuna corrispondenza)
	 * @param findB
	 *            - Intervallo trovato uguale nello spazio esaminato(size <=0 se
	 *            nn viene trovata nessuna corrispondenza)
	 */
