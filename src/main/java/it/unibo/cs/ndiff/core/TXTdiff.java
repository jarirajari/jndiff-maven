...
import it.unibo.cs.ndiff.common.vdom.diffing.Sequence;
...
/**
 * @author Mike Classe che si occupa di fare il diff del contenuto di nodi di
 *         testo
 */
public class TXTdiff {
	...
	/**
	 * Confronta le sequenze dei due Vnode, e inserisce il risultato MetaDelta,
	 * nel VnodeB, alla posizione indexA. Quindi nel VnodeB, ci sarà un vettore
	 * che contiene i MetaDelta relativi al confronto con determinati nodi del
	 * documento originale.
	 * 
	 * @param nA
	 *            Nodo del documento originale del quale si vuole fare il diff
	 * @param nB
	 *            Nodo del documento modificato del quale si vuole fare il diff
	...
	public static void compute(Sequence seqA, Sequence seqB) {
		...
		// System.out.println(A.show(true));
	...
	/**
	 * Crea il METAdelta relativo al delta calcolato Il METAdelta viene aggiunto
	 * al VnodeB
	 */
	public static void createMiniDelta() {
		...
		for (int i = 0; i < dom.size(); i++) {
			...
			// System.out.println(" DELETE --> "+pStart+":"+length);
	 ...
	 * 
	 * @param intA
	 *            Intervallo di ricerca nella sequenza A
	 * @param intB
	 *            Intervallo di ricerca nella sequenza B
	 ...
	 * 
	 * @param la
	 *            Lunghezza del testo nel documento originale
	 * @param lb
	 *            Lunghezza del testo nel documento modificato
	 * @param c
	 *            Lunghezza del testo comune
	...
	/**
	 * Restituisce la LCCS trovata negli intervalli di ricerca specificati
	 * 
	 * @param intA
	 *            Intervallo di ricerca nella sequenza A
	 * @param intB
	 *            Intervallo di ricerca nella sequenza B
	 * @param findA
	 *            Intervallo trovato nella sequenza A
	 * @param findB
	 *            Intervallo trovato nella sequenza B
	 */
