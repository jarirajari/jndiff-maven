...
package it.unibo.cs.ndiff.common.vdom;
...
public class DOMDocument {
	...
	public DOMDocument(String namespace, String rootname) {
		...
		logger.info("Creating new DOMdocument, namespace:" + namespace
				+ " root:" + rootname);
	...
	public void strongNormalize(boolean ltrim, boolean rtrim, boolean collapse,
		...
		logger.info("Normalizing document ltrim:" + ltrim + " rtrim:" + rtrim
