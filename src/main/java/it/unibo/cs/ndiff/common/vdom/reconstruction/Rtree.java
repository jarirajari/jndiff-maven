...
package it.unibo.cs.ndiff.common.vdom.reconstruction;

import it.unibo.cs.ndiff.common.vdom.Vtree;
...
public class Rtree extends Vtree<Rnode> {
	...
	public void WRAP(Integer nodenumber, Integer at, Integer pos, Integer children, String nodename, Node content) {
		...
		logger.info(" WRAP nodenumber:" + nodenumber + " at:" + at + " pos:" + pos
				+ " children:" + children);
	...
	public void ATTCHANGE(Integer nodenumber, String name, String newValue, String oldValue, String operation) {
		logger.info(" ATTCHANGE nn:" + nodenumber + " name:" + name + " newValue:"+ newValue);
		...
		markup.setAttribute(Operation.NODE_NUMBER_ATTR, nodenumber.toString() );
	...
	public void ATTINSERT(Integer nodenumber, String name, String newValue, String operation) {
		logger.info(" ATTINSERT nn:" + nodenumber + " name:" + name + " value:" + newValue);
		Element editNode = (Element) getNode(nodenumber).refDomNode;
		editNode.setAttribute(name, newValue);
	...
	public void ATTDELETE(Integer nodenumber, String name, String operation) {
		logger.info(" ATTDELETE nn:" + nodenumber + " name:" + name);
		Element editNode = (Element) getNode(nodenumber).refDomNode;
	...
	public void DEL(Integer nn, Integer pos, Integer length) {
		logger.info(" DEL nn:" + nn + " pos:" + pos + " length:" + length);
		checkEditing(nn);
	...
	public void DELETE(Integer nn, Integer nodecount, String move) {
		...
		logger.info(" DELETE nn:" + nn + "(" + (nn - nodeDeleted)
				+ ") nodecount:" + nodecount);
	...
	public void UNWRAP(Integer nodenumber, String nodename) {
		...
		logger.info(" UNWRAP nn:" + nodenumber + "(" + (nodenumber - nodeDeleted) + ")");
		...
		markupFather.setAttribute(Operation.NODE_NUMBER_ATTR, nodenumber.toString() );
	...
	public void INS(Integer nn, Integer pos, Integer length, Node content) {
		logger.info(" INS nn:" + nn + " pos:" + pos + " length:" + length);
		checkEditing(nn);
	...
	public void INSERT(Integer nodenumber, Integer at, Integer pos, Integer nodeCount,
		...
		logger.info(" INSERT nn:" + nodenumber + " at:" + at + " pos:" + pos
				+ " nodeCount:" + nodeCount);
	...
	public boolean isMarkupHowDelete(Node node) {
		...
		logger.info(" *** Test node:" + node.getNodeName());

		if (node.getNodeType() == Node.ELEMENT_NODE) {
			Element tmp = (Element) node;

			logger.info("Cast to Element node  prefix:" + tmp.getPrefix()
					+ " name:" + tmp.getNodeName());
			logger.info("Attribute status:" + tmp.getAttribute(Operation.STATUS_ATTR));
			logger.info("Attribute ndiff:status:"
